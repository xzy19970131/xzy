...
<div id="loginDiv" class="account-wrapper">
	...
	<form  id="loginForm" class="form-reg" method="post" action="UserServlet" />
		...
		<%}else{ %>
			<a  href="javascript:void()" class="loged">
...
<!-- 			<input class="input-medium" type="password"  name="password"/> -->
		...
		<p class="forgot-pass">
			<a href="#">忘记密码?</a>&nbsp;&nbsp;&nbsp;<a href="#"><input type="checkbox" style="position: relative;top: 2px;">记住我 </a>
		</p>
		<p>
...
// 				alert(location.href);
// // 				location.href="/searchAll.jsp?searchKey="+$("#s").val();
// 			})
	});
	</script>
