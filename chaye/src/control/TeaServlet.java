...
public class TeaServlet extends HttpServlet {
	 ...
	 *  
	 **/
	private void mohuSearch(HttpServletRequest request, HttpServletResponse response)
			throws IOException {
	String key=request.getParameter("key");
	ArrayList<String> pipeis = dao.mohuSearchList(key);
	System.out.println(pipeis);
	
	response.setContentType("text/xml;charset=UTF-8");  					//自定义一个xml文档
