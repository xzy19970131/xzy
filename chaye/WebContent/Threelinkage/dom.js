 ...
 */
{
	...
	injectCss : function() {
		if(arguments.length == 1) {
			...
			// Takes a string of css, inserts it into a `<style>`, then injects it in at the very top of the `<head><base href="${pageContext.request.scheme }://${pageContext.request.serverName}:${pageContext.request.serverPort}/chaye/"><meta charset="utf-8" />`. This ensures any user-defined styles will take precedence.
